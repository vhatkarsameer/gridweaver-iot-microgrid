...
const HouseholdMarker = memo(
  function HouseholdMarker({ household, onSelect }) {
    ...
    const longitude = toNumber(
      household.longitude ?? household.lng ?? household.lon,
      NaN,
    );
    ...
    const consumptionKw =
      toNumber(household.consumptionWatts ?? household.powerWatts) / 1000;
    const batteryLevelPct = toNumber(
      household.batteryLevelPct ?? battery.batteryLevelPct,
    );
